...
class LoopBlockNeedsParamError : SoundSyntaxError(R.raw.alerta_falta_uma_peca_repita)
class IfBlockNeedsParamError : SoundSyntaxError(R.raw.alerta_falta_uma_peca_se)
